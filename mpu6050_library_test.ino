...
void setup() {
  ...
  SetAccelerometerRange(MPU6050_ACCEL_FS_8);
  GyroDLPF_Config(MPU6050_DLPF_0_BANDWIDTH_256);

  // Serial.print("0x");
  // Serial.println(ReadRegister(0x1C), HEX);

  GyroscopeAndAccelerometerCalibration(&Acc_Offset_X, &Acc_Offset_Y, &Acc_Offset_Z,
                                       &Gyro_Offset_X, &Gyro_Offset_Y, &Gyro_Offset_Z,
                                       MPU6050_ACCEL_FS_8, MPU6050_GYRO_FS_500, 2000, 2);
